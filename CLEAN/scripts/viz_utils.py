...
# Fixed colour sequence for the 4 clusters (k=4, label-stable).
_LABEL_COLORS = {
    'Petrostates':           '#E63946',   # red
    'Oil Exporters':         '#457B9D',   # blue
    'Diversified Exporters': '#2A9D8F',   # teal
    'Gold & Coal':           '#E9C46A',   # gold/yellow
}


# ---------------------------------------------------------------------------
# 54-country analysis sample (k=4 clustering — single source of truth)
# ---------------------------------------------------------------------------
INCLUDE_LIST = [
